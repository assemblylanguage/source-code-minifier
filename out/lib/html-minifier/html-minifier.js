/**
 * This file contains the source code for a patched version of Juriy "kangax"
 * Zaytsev's `html-minifier` library. This version excludes the dependencies
 * on the 'uglify-js' and 'clean-css' libraries.
 */
'use strict';
var decode = require('he').decode;
var HTMLParser = require('./html-parser').HTMLParser;
...
function isUriTypeAttribute(attrName, tag) {
    return (/^(?:a|area|link|base)$/.test(tag) && attrName === 'href' ||
...
function isNumberTypeAttribute(attrName, tag) {
    return (/^(?:a|area|object|button)$/.test(tag) && attrName === 'tabindex' ||
...
var reEmptyAttribute = new RegExp('^(?:class|id|style|title|lang|dir|on(?:focus|blur|change|click|dblclick|mouse(' +
...
//# sourceMappingURL=html-minifier.js.map